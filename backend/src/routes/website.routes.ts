...
import { createWebsite, deleteWebsite, generateWebsite, getWebsite, getWebsites, updateWebsite ,getPublicWebsite} from "../controllers/website.controller";
...
websiteRouter.get("/public/:id", getPublicWebsite);
